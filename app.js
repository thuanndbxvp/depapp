...
const STATIC_ENTRIES = [
  {
    ...
    backup_download_url: 'https://drive.google.com/file/d/18_Qoc7_JYa9o6wneR9BhmuIoP7cdAb5X/view?usp=sharing',
  },

  {
    ...
    backup_download_url: 'https://drive.google.com/file/d/1kdHCTymOPI84QOzfC5e98QCMvSrPVDjr/view?usp=drive_link',
  },
    {
    name: 'Autosync V2',
...
function makeCard(e, idx) {
  ...
  const backupBtnHtml = e.backup_download_url
    ? `<button class="btn-flat btn-backup" onclick="openUrl('${e.backup_download_url}')">⬇ Bản dự phòng</button>`
    : '';
  const fallbackGuideBtnHtml = e.fallback_guide_tab !== undefined
    ? `<button class="btn-flat" onclick="switchTab(${e.fallback_guide_tab});showGuide()">🧩 Link dự phòng</button>`
    : '';
